...
import profileImage from '../../assets/Im_smug.png'
const Header = () => {
    return (
        <div className='flex flex-col gap-3'>
            <img className='profile-image h-64 w-full object-contain object-left' src={profileImage} alt='Portrait of the portfolio owner' />
